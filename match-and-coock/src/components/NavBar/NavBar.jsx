...
const NavBar = () => {
  return (
    ...
    <Container fluid> 
      ...
      <div>
      <button type="submit" className="btn  btn-outline-light rounded-pill  border-field box-shadow">Iniciar sesión</button>
        <button type="submit" className="btn  btn-gradient rounded-pill  border-field box-shadow ms-2">Registrarse</button>
      </div>     
    </Container>
